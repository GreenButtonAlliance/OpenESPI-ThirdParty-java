...
public class EspiFactory {
    ...
    public static UsagePoint newUsagePoint(UUID uuid) {
        return newUsagePoint(newRetailCustomer(), uuid);
    }
    ...
    public static UsagePoint newUsagePoint(RetailCustomer retailCustomer) {
        return newUsagePoint(retailCustomer, UUID.randomUUID());
    }

    public static UsagePoint newUsagePoint(RetailCustomer retailCustomer, UUID uuid) {
        UsagePoint usagePoint = new UsagePoint();

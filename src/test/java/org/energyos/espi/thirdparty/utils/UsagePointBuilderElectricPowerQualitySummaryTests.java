...
import org.energyos.espi.thirdparty.domain.ElectricPowerQualitySummary;
...
public class UsagePointBuilderElectricPowerQualitySummaryTests {
    ...
    public void before() throws IOException, JAXBException {
        ...
        electricPowerQualitySummary = builder.newUsagePoints(feedType).get(0).getElectricPowerQualitySummaries().get(0);
    }

    @Test
    public void buildsElectricPowerQualitySummary() {
        assertEquals(ElectricPowerQualitySummary.class, electricPowerQualitySummary.getClass());
    }

    @Test
    public void setsDescription() {
        assertNotNull(electricPowerQualitySummary.getDescription());
    }

    @Test
    public void setsMRID() {
        assertNotNull(electricPowerQualitySummary.getMRID());
    }
}
